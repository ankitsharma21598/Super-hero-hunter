...
async function loadChars(query){
    const URL = `http://gateway.marvel.com/v1/public/characters?nameStartsWith=${query}&ts=1&apikey=6e987814682000c377739dc61afcdd2f&hash=71340394460c05df96be535c51cf4ff9`
...
function displayLoadHeros(data){
    ...
    `<li id="home-single-hero">
      <div id="home-hero-info">
        ...
        <div id="bottom">
            <h4 id="home-hero-name"> ${ data[i].name }</h4>
