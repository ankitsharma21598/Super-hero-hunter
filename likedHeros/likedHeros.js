...
for(let i = 0 ; i < favHeros.length ; i++)
    {
        ...
        async function showDetails(query){
          const URL = `https://gateway.marvel.com:443/v1/public/characters/${query}?ts=1&apikey=6e987814682000c377739dc61afcdd2f&hash=71340394460c05df96be535c51cf4ff9`
      ...
      function displayCharDetailsUpdate(data){
        ...
        `<li id="single-hero">
          <div id="hero-info">
            ...
            <div id="bottom">
                <h4 id="hero-name"> ${ data[0].name }</h4>
